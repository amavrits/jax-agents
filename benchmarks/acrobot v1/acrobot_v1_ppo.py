...
from acrobot_nn_gallery import *
import matplotlib
...
if __name__ == '__main__':
    ...
    hyperparams = ppo.HyperParameters(
        ...
        ent_coeff=0.01,
        vf_coeff=1.0,
        actor_optimizer_params=ppo.OptimizerParams(learning_rate=1e-4, eps=1e-3, grad_clip=1),
    ...
    eval_metrics = agent.eval(rng_eval, n_evals=256)
    ...
    plt.plot(np.arange(1, agent.config.n_steps+1), training_rewards.episode_metric.mean(axis=1), c='b')
